package com.wyp.framework.aspectj;
...
import com.wyp.common.enums.BusinessStatus;
import com.wyp.common.json.JSON;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.wyp.common.annotation.Log)")
